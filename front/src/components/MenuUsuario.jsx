        ...
        <div className="flex justify-center">
            <div className="absolute -top-64 flex flex-col items-center bg-gray-200 hover:translate-y-64 duration-200 w-1/4 pt-10 rounded-b-xl justify-center z-10 min-w-80">
                <div className="flex flex-wrap gap-y-3 gap-x-3 justify-center">
                    <BtnMenuDesplegable name="Registrar" onClick={() => opcionCrearUsuario()}></BtnMenuDesplegable>
                    <BtnMenuDesplegable name="Eliminar" onClick={() => opcionEliminarUsuario()}></BtnMenuDesplegable>
                    <BtnMenuDesplegable name="Editar"></BtnMenuDesplegable>
                    <BtnMenuDesplegable name="Consultar"></BtnMenuDesplegable>
                </div>
