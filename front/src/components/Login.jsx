    ...
    return (
        <div className="bg-slate-100 w-80 mx-auto m-8 rounded-lg p-8">
            ...
            <form onSubmit={e=>e.preventDefault()}>
                ...
                <button className="bg-slate-800 text-white rounded-lg px-4 py-2 w-full hover:bg-slate-700 mb-6 cursor-pointer " onClick={()=>validacionLogin(usuarioInput,contrasenaInput)}>Ingresar</button>
